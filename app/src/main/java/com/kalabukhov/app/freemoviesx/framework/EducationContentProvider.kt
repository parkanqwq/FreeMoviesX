...
import com.kalabukhov.app.freemoviesx.model.database.*
...
class EducationContentProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        ...
        // Нотификация на изменение Cursor'а
    ...
    private fun map(values: ContentValues?): HistoryEntity {
        return if (values == null) {
            ...
            val originalTitle = values[ORIGINAL_TITLE] as String
            val releaseDate = values[RELEASE_DATE] as Int
            HistoryEntity(id, releaseDate, originalTitle)
        }
    }
}
